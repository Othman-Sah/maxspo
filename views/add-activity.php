                    ...
                    <div class="lg:col-span-2 space-y-6">
                        <form method="POST" action="index.php?page=add-activity" class="bg-white p-8 rounded-[32px] border border-slate-100 shadow-sm space-y-6">
                            ...
                            <div class="grid grid-cols-2 gap-6 pt-4">
                                <div class="space-y-2">
                                    <label class="text-[10px] font-black uppercase text-slate-400 tracking-widest">Prix Annuel (DH)</label>
                                    <div class="relative">
                                        ...
                                        <input 
                                            ...
                                            onkeyup="document.getElementById('previewPrice').innerText = this.value + ' DH / An';"
                                        />
                                    </div>
                                </div>
                                <div class="space-y-2">
