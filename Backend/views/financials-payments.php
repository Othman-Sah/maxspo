                ...
                <div id="tab-analysis" class="space-y-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div class="bg-slate-900 p-8 rounded-[32px] text-white shadow-xl shadow-slate-200 relative overflow-hidden group">
                            ...
                            <p class="text-white/40 text-[10px] font-black uppercase tracking-widest mb-1">Net Profit</p>
                        ...
                        <div class="bg-slate-900 p-8 rounded-3xl shadow-xl shadow-slate-200 text-white space-y-6">
                            <form id="filter-form" method="get">
                                ...
                                <div class="flex items-center justify-between">
                                    ...
                                    <a href="?page=financials-payments" class="text-xs font-bold text-slate-400 hover:text-white transition-colors">Reset</a>
                                </div>
                                <div class="space-y-4 mt-6">
                                    <div>
                                        <label class="text-[10px] font-black uppercase text-slate-400 mb-2 block tracking-widest">Monthly Period</label>
